...
The AwsBedrock SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package AwsBedrock
```
...
using var client = new AwsBedrockClient(
    apiKey: Environment.GetEnvironmentVariable("AWSBEDROCK_API_KEY")!);
